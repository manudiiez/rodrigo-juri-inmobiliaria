  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          href={`https://wa.me/5492614123456?text=${encodeURIComponent(`Consulta por ${property.nombre}`)}`}
          target="_blank"
          rel="noopener noreferrer"
          className="bg-green-500 hover:bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
        >
