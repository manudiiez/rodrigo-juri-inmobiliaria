              ...
              {[
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/propuestas/design-b/propiedades/${idx}`} className="block w-full py-3 border border-bordeaux text-bordeaux-dark hover:bg-bordeaux hover:text-white rounded-lg transition-all duration-300 font-medium text-center">
                      Ver Ficha Técnica
                    </Link>
                  </div>
                </div>
