  ...
  return (
     <section className="bg-bordeaux-dark text-white py-16 px-6 md:px-12 lg:px-12 pt-32">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 items-start gap-2">
        ...
        <div className="w-full pt-3 lg:pl-4">
          {/* Tabs */}
          <div className="flex flex-wrap gap-8 text-xs md:text-sm font-semibold tracking-[0.25em] uppercase text-slate-300">
            {/* Tab activo */}
            <button
              type="button"
              className={`relative pb-2 ${activeTab === 'comprar' ? 'text-white' : 'hover:text-white transition-colors cursor-pointer'}`}
            ...
            <button
              type="button"
              className={`relative pb-2 ${activeTab === 'alquilar' ? 'text-white' : 'hover:text-white transition-colors cursor-pointer'}`}
            ...
            <button
              type="button"
              className={`relative pb-2 ${activeTab === 'vender' ? 'text-white' : 'hover:text-white transition-colors cursor-pointer'}`}
            ...
            <button
              type="button"
              className={`relative pb-2 ${activeTab === 'agentes' ? 'text-white' : 'hover:text-white transition-colors cursor-pointer'}`}
          ...
          <div className="mt-6 flex items-center gap-3 border-b border-slate-500 pb-3">
            ...
            <button
              type="button"
              className="ml-2 flex h-8 w-8 items-center justify-center rounded-full border border-slate-500 hover:bg-slate-100/10 transition-colors"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
